...
export class UKLegalAPIs {
  ...
  async searchCompany(query: string): Promise<CompanyInfo[]> {
    ...
    try {
      ...
      throw new Error(`Companies House API unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async getCompanyDetails(companyNumber: string): Promise<CompanyInfo> {
    ...
    try {
      ...
      console.error('Companies House API error:', error);
      throw new Error(`Company details unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async searchLegislation(
    ...
    try {
      ...
      throw new Error(`Legislation search unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async getLegislationDetails(url: string): Promise<LegislationData> {
    ...
    try {
      ...
      console.error('Legislation API error:', error);
      throw new Error(`Legislation details unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async searchCaseLaw(query: string, court?: string): Promise<CourtCase[]> {
    ...
    try {
      ...
      console.error('BAILII API error:', error);
      throw new Error(`Case law search unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async searchLandRegistry(address: string): Promise<LandRegistryData[]> {
    ...
    try {
      ...
      throw new Error(`Land Registry search unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async searchGovernmentServices(query: string): Promise<GovernmentService[]> {
    ...
    try {
      ...
      throw new Error(`Government services search unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  async getCourtDetails(courtName: string): Promise<any> {
    ...
    try {
      ...
      console.error('HMCTS API error:', error);
      throw new Error(`Court details unavailable: ${error instanceof Error ? error.message : String(error)}`);
    }
  }
  ...
  // All mock data removed - production system uses real APIs or fails gracefully
}
