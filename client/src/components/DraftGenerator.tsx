                    ...
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center gap-2">
                          ...
                          <h4 className="font-medium text-sm">{draft.templateName || 'Untitled Draft'}</h4>
                        </div>
...
const mockTemplates: Template[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'applicationType', label: 'Application Type', type: 'select', options: ['Injunction', 'Discovery', 'Summary Judgment', 'Other'], required: true },
