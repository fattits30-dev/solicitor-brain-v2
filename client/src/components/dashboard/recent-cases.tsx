            ...
            <Link key={case_.id} href={`/cases/${case_.id}`}>
              ...
              >
                ...
                <div className="text-right">
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getPriorityColor(case_.priority)}`}
                  ...
                  >
                    {formatTimeAgo(case_.updatedAt ? case_.updatedAt.toString() : new Date().toISOString())}
                  </p>
                </div>
              </div>
            </Link>
