      ...
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <Button onClick={setupTotp} disabled={loading || !email} className="w-full">
              {loading ? (
                <>
          ...
          <Tabs defaultValue="status" className="w-full">
            ...
            <TabsContent value="status" className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {status.unusedBackupCodes} unused codes
                      </p>
                    </div>
                  </div>
              ...
              {status.deviceTrusted && (
                <Alert>
                  ...
                  <AlertDescription>
                    This device is trusted. You won't need to provide MFA codes for{' '}
                    {Math.ceil((new Date().getTime() - Date.now()) / (1000 * 60 * 60 * 24))} more
                    days.
                  </AlertDescription>
                </Alert>
              )}
            ...
            <TabsContent value="backup" className="space-y-4">
              <Alert>
                <Key className="h-4 w-4" />
                <AlertDescription>
                  Backup codes are single-use codes that can be used if you lose access to your
