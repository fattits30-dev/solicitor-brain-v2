  ...
  const resetMfa = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: "MFA Reset",
          description: "Your MFA settings have been reset. You can set up new authentication methods.",
        });
        setTimeout(() => {
          onRecoverySuccess();
        }, 2000);
      ...
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardContent className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              Account recovery is a security-sensitive process. Please choose the method that best matches your situation.
            </AlertDescription>
          </Alert>
      ...
      return (
        <Card className="w-full max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Use one of your saved backup codes to regain access
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {error && (
            ...
            <Alert>
              <AlertTriangle className="h-4 w-4" />
              <AlertDescription>
                Backup codes are single-use only. This code will be invalidated after successful use.
              </AlertDescription>
            </Alert>
      ...
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardContent className="space-y-6">
          <Alert>
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription>
              This will disable your current MFA settings. You'll need to set up new authentication methods after reset.
            </AlertDescription>
          </Alert>
    ...
    return (
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Your MFA recovery process has been completed
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <Alert>
