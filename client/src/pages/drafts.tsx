  ...
  const createDraftMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: 'Your draft has been saved and is ready for editing.',
      });
    },
    onError: () => {
      toast({
          ...
          <Dialog open={showCreateModal} onOpenChange={setShowCreateModal}>
            ...
            <DialogContent className="max-w-2xl" data-testid="create-draft-modal">
              <DialogHeader>
                ...
                <DialogDescription>
                  Generate a legal document draft using AI assistance with your chosen tone and
                  style.
                </DialogDescription>
              </DialogHeader>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                          ...
                          <SelectContent>
                            {cases?.map((case_) => (
                              <SelectItem key={case_.id} value={case_.id.toString()}>
                                {case_.title} {case_.caseReference && `(${case_.caseReference})`}
                              </SelectItem>
                            ))}
                          </SelectContent>
                        </Select>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="e.g., Response to Settlement Offer, Notice of Appeal"
                            {...field}
                  ...
                  <div className="border border-border rounded-lg p-4 bg-muted/30">
                    ...
                    <p className="text-sm text-muted-foreground">
                      AI will create a draft based on your case details using the selected tone
                      preset. You can then edit and refine the content.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col-reverse sm:flex-row gap-3">
                    <Button
                      ...
                      className="flex-1"
                      data-testid="cancel-create-draft"
                    >
                      Cancel
                    </Button>
                    <Button
                      ...
                      className="flex-1"
                      data-testid="submit-create-draft"
                    >
          ...
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose the appropriate tone for your legal documents
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                {!drafts || drafts.length === 0 ? (
                  <div className="text-center text-muted-foreground p-8" data-testid="no-drafts">
                    ...
                    <Button
                      ...
                      data-testid="create-first-draft"
                    >
                      <i className="fas fa-plus mr-2"></i>
                  ...
                  <div className="space-y-4">
                    {drafts.map((draft) => {
                      ...
                      const toneInfo = tonePresets.find((t) => t.value === metadata?.tone);
                          ...
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center space-x-3">
                              <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center">
                                <i
                                  className={`${toneInfo?.icon || 'fas fa-edit'} text-primary`}
                                ></i>
                              </div>
                              <div>
                                <h3
                                ...
                                <p
                                  ...
                                  data-testid={`draft-case-${draft.id}`}
                                >
                            ...
                            <div className="flex items-center space-x-2">
                              <Badge
                                className={toneInfo?.color}
                                variant="outline"
                                data-testid={`draft-tone-${draft.id}`}
                              >
                                {toneInfo?.label || metadata?.tone || 'Unknown'}
                              </Badge>
                              <Badge
                                className={getStatusColor(metadata?.status || 'draft')}
                          ...
                          <div className="flex items-center justify-between text-xs text-muted-foreground">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                data-testid={`export-draft-${draft.id}`}
                              >
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Best practices for AI-assisted legal document creation
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      AI-generated content must be reviewed and verified by qualified legal
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Customize generated drafts for your specific case circumstances and client
                      needs.
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Verify all legal references, citations, and procedural requirements
                      independently.
                    </p>
                  </div>
                </div>
