...
export default function Audit() {
  ...
  const [_userFilter, _setUserFilter] = useState('all');
  ...
  const getActionIcon = (action: string) => {
    switch (action) {
      ...
      case 'case_deleted':
        return 'fas fa-trash text-destructive';
      case 'document_uploaded':
        return 'fas fa-upload text-accent';
      case 'document_viewed':
        return 'fas fa-eye text-muted-foreground';
      case 'search_executed':
        return 'fas fa-search text-primary';
      case 'draft_generated':
        return 'fas fa-robot text-secondary';
      case 'ai_processing':
        return 'fas fa-brain text-primary';
      case 'consent_granted':
        return 'fas fa-check-circle text-secondary';
                ...
                <div className="space-y-4">
                  {filteredLogs.length === 0 ? (
                    ...
                    >
                      ...
                      <p className="text-sm">
                        No audit entries match your current filters. Try adjusting the search
                        criteria.
                      </p>
                    </div>
                  ) : (
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p
                                ...
                                data-testid={`audit-timestamp-${log.id}`}
                              >
                          ...
                          <div className="flex items-center space-x-2">
                            <Badge
                              ...
                              data-testid={`audit-action-badge-${log.id}`}
                            >
                              {log.action}
                            </Badge>
                        ...
                        <div className="space-y-2">
                          <div className="text-sm">
                            ...
                            <span
                              ...
                              data-testid={`audit-description-${log.id}`}
                            >
                          ...
                          {log.metadata && (
                            <div className="text-sm">
                              ...
                              <span
                                className="text-foreground"
                                data-testid={`audit-metadata-${log.id}`}
                              >
                                {Object.entries(log.metadata)
                                  .map(
                                    ([key, value]) => `${key}: ${showPII ? value : '[REDACTED]'}`,
                                  )
                                  .join(', ')}
                              </span>
                            </div>
                          ...
                          <div className="text-sm">
                            ...
                            <span
                              ...
                              data-testid={`audit-resource-id-${log.id}`}
                            >
                              {log.resourceId}
                            </span>
                          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Personal information is automatically detected and redacted from audit logs
                      and search indexes.
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Audit logs are retained for 7 years as required by UK legal practice
                      regulations.
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Generate compliance reports and export audit trails for regulatory
                      requirements.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-destructive/80">
                        You have enabled the display of potentially sensitive information. This
                        should only be used for authorized compliance reviews.
                      </p>
                    </div>
                  </div>
                </CardContent>
