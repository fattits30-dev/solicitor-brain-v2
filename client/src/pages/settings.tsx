...
export default function Settings() {
  ...
  const onAISubmit = (_data: AISettings) => {
  ...
  const onPrivacySubmit = (_data: PrivacySettings) => {
              ...
              <TabsContent value="ai" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Configure local AI models for document processing and generation
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Form {...aiForm}>
                              ...
                              <FormItem>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    ...
                                    <SelectItem value="phi3:3.8b">
                                      Phi-3 3.8B (Efficient)
                                    </SelectItem>
                                  </SelectContent>
                                </Select>
                                <FormDescription>
                                  Model used for draft generation and content analysis
                                </FormDescription>
                                <FormMessage />
                              </FormItem>
                            )}
              ...
              <TabsContent value="privacy" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Manage consent, data redaction, and privacy preferences
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Form {...privacyForm}>
                            ...
                            render={({ field }) => (
                              <FormItem className="flex items-center justify-between space-y-0">
                                <div className="space-y-1">
                                  ...
                                  <FormDescription>
                                    Automatically detect and redact personal information in logs and
                                    search results
                                  </FormDescription>
                                </div>
                                <FormControl>
                            ...
                            render={({ field }) => (
                              <FormItem className="flex items-center justify-between space-y-0">
                                <div className="space-y-1">
                                  ...
                                  <FormDescription>
                                    Show consent dialogs before processing documents with AI
                                    technology
                                  </FormDescription>
                                </div>
                                <FormControl>
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <Select
                                  onValueChange={field.onChange}
                                  value={field.value}
                                  data-testid="select-audit-retention"
                                >
                                  <FormControl>
                                    <SelectTrigger>
                                      <SelectValue />
                ...
                <Card className="border-destructive">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Irreversible actions that affect your data and privacy
                    </CardDescription>
                  </CardHeader>
                    ...
                    <div className="flex items-center justify-between p-4 border border-destructive/20 rounded-lg bg-destructive/5">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Stop all AI processing and remove existing consent records
                        </p>
                      </div>
                      <Button
                        variant="destructive"
                        onClick={handleRevokeAllConsent}
                        data-testid="revoke-all-consent"
                      >
              ...
              <TabsContent value="data" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Export your data and manage storage preferences
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Export all your case data, documents, and AI-generated content in your
                          preferred format.
                        </p>
                        <Button
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span
                              className="text-foreground font-medium"
                              data-testid="storage-embeddings"
                            >
                              12,847 vectors
                            </span>
                          </div>
                ...
                <Card>
                  ...
                  <CardContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <Badge variant="outline" data-testid="app-version">
                              v1.0.0
                            </Badge>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-muted-foreground">Environment:</span>
                            <Badge variant="outline" data-testid="app-environment">
                              Development
                            </Badge>
                          </div>
                          <div className="flex justify-between">
                            ...
                            <Badge
                              ...
                              variant="outline"
                              data-testid="database-status-system"
                            >
                              Connected
                            </Badge>
                          </div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <Badge
                              className="text-secondary"
                              variant="outline"
                              data-testid="ocr-service-status"
                            >
                              Available
                            </Badge>
                          </div>
                    ...
                    <div className="mt-6 p-4 bg-muted/30 rounded-lg">
                      ...
                      <p className="text-sm text-muted-foreground">
                        A trauma-informed, privacy-first legal case management system with
                        AI-powered assistance. Built specifically for UK solicitors with
                        comprehensive data protection and audit capabilities.
                      </p>
                    </div>
                  </CardContent>
                </Card>
