import { DocumentManager, DocumentUpload } from '@/components/documents';
...
import { FileText, Key, Server, Shield, Upload } from 'lucide-react';
        ...
        <div className="flex-1 overflow-hidden p-6">
          <div className="h-full flex flex-col space-y-6">
                    ...
                    <SelectContent>
                      {cases?.map((case_) => (
                        <SelectItem key={case_.id} value={case_.id.toString()}>
                          {case_.title} ({case_.caseReference})
                        </SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
            ...
            <div className="flex-1 overflow-hidden">
              <Tabs
                value={view}
                onValueChange={(v) => setView(v as 'upload' | 'manager')}
                className="h-full"
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Personal information is automatically detected and redacted from search
                        indexes, logs, and AI processing to maintain client confidentiality.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        You control exactly which AI features process your documents. Consent can be
                        revoked at any time with full data deletion.
                      </p>
                    </div>
                  </div>
                </div>
